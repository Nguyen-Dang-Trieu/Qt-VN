...
Popup {
    ...
    ColumnLayout {
        ...
        Text {
            text: "Are you sure you want to delete '" + root.vaultName + "'? This action cannot be undone."
            color: "#94a3b8"
            font.pixelSize: 12
        ...
        RowLayout {
            ...
            Button {
                Layout.fillWidth: true; height: 35; text: "Cancel"
            ...
            Button {
                Layout.fillWidth: true; height: 35; text: "Delete"
