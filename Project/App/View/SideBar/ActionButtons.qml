...
ColumnLayout {
    ...
    signal importClicked() // add 20260414
    ...
    // Nút "Import Vault" (MỚI)
    Rectangle {
        Layout.fillWidth: true
        height: 38
        color: "transparent" // Nền trong suốt hoặc màu xám nhạt để phân biệt với nút Create
        radius: 8
        border.color: "#1e293b" // Viền mỏng
        border.width: 1
        ...
        MouseArea {
            ...
            onClicked: actionRoot.importClicked() // Phát tín hiệu
        }
    }
